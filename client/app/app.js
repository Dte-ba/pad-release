...
angular.module('padApp').controller('ContactoCtrl', function ($rootScope, $timeout, seoService, $stateParams) {
...
angular.module('padApp').directive('padAsideMenu', function () {
  return {
    template: ['  <ul>', '    <li data-target="bienvenida">', '      <a ui-sref="bienvenido.presentacion" data-toggle="tooltip" data-placement="top" title="Bienvenida"><div class="expand"></div></a>', '    </li>', '    <li data-target="cloud">', '      <a ui-sref="tangibles.design({area: \'PAD en acción\', axis: \'PAD en acción\', block: \'Sin Especificar\'})" data-toggle="tooltip" data-placement="right" title="PAD en acción"><div class="expand"></div></a>', '    </li>', '    <li data-target="orientaciones">', '      <a ui-sref="orientacion" data-toggle="tooltip" data-placement="right" title="Orientaciones"><div class="expand"></div></a>', '    </li>', '    <li data-target="transversales">', '      <a ui-sref="transversales" data-toggle="tooltip" data-placement="right" title="Transversales"><div class="expand"></div></a>', '    </li>', '    <li data-target="contacto">', '      <a ui-sref="contacto" data-toggle="tooltip" data-placement="right" title="Contacto"><div class="expand"></div></a>', '      <!--<a href="http://servicios2.abc.gov.ar/lainstitucion/organismos/direccion_de_tecnologia_educativa/pad/contacto.html"  target="_blank"', '         data-toggle="tooltip" data-placement="bottom" title="Contacto"><div class="expand"></div></a>-->', '    </li>', '  </ul>', '  <div class="center-aside-menu"></div>'].join('\n'),
    restrict: 'A',
...
$templateCache.put("app/bienvenido/presentacion.html","<div class=\"aboutus\">\n  <h4>Autoridades</h4>\n\n  <ul class=\"creditos-ceremonial\">\n    <li>\n      <p><strong>Gobernadora</strong> <br />\n      <span>Lic. María Eugenia Vidal </span></p>\n    </li>\n    <li>\n      <p><strong>Vicegobernador</strong> <br />\n      <span>Dr. Daniel Salvador </span></p>\n    </li>\n    <li>\n      <p><strong>Director General de Cultura y Educación</strong> <br />\n      <span>Dr. Alejandro Finocchiaro </span></p>\n    </li>\n    <li>\n      <p><strong>Vicepresidente 1º del Consejo General de Cultura y Educación</strong> <br />\n      <span>Dr. Claudio Crissio </span></p>\n    </li>\n    <li>\n      <p><strong>Jefe de Gabinete de Asesores</strong> <br />\n      <span>Don Javier Mezzamico </span></p>\n    </li>\n    <li>\n      <p><strong>Subsecretario de Educación</strong> <br />\n      <span>Lic. Sergio Siciliano </span></p>\n    </li>\n    <li>\n      <p><strong>Director Provincial de Tecnología de la Educación</strong> <br />\n      <span>Lic. Gustavo Goenaga </span></p>\n    </li>\n    <li>\n      <p><strong>Área Tecnología Educativa</strong> <br />\n      <span>Prof. Liliana Vigolo </span></p>\n    </li>\n  </ul>\n\n  <h4>Equipo del Programa de Alfabetización Digital -PAD-</h4>\n\n  <ul class=\"creditos-equipo\">\n    <li><span><strong>Equipo del Programa de Alfabetización Digital -PAD-</strong></span></li>\n    <li><span><strong>Equipo técnico-pedagógico</strong></span></li>\n    <li><span>Silvia Ramírez  - Referente Nivel Primario</span></li>\n    <li><span>Liliana Sabat - Referente Contenidistas, Generalista</span></li>\n    <li><span>Graciela Fernández Troiano - Contenidista Artística, Leng Plástica </span></li>\n    <li><span>Silvia Perassolo - Contenidista Matemática</span></li>\n    <li><span>Miriam Inés Volosín - Generalista, EOE</span></li>\n    <li><span>Leandro Radesh - Contenidista EFI</span></li>\n    <li><span>Verónica Clar – Contenidista Matemática</span></li>\n    <li><span>Jorgelina Savino – Contenidista Inglés</span></li>\n    <li><span>Marisa Velazquez – Contenidista Artística, Leng Danza</span></li>\n    <li><span>Rocío Velazquez – Contenidista Artistica, Leng Música </span></li>\n    <li><span>Juliana Ricardo- Contenidista Prácticas del Lenguaje</span></li>\n  </ul>\n\n  <ul class=\"creditos-equipo\">\n    <li><strong>Equipo de desarrollo</strong></li>\n    <li><span>Alejandro Palestrini <small>(Creación y coord. entorno)</small></span></li>\n    <li><span>Delmo Carrozzo <small>(Arq. de software)</small></span></li>\n    <li><span>Rodrigo Bonilla <small>(Diseño UI & UX)</small></span></li>\n    <li><span>María Elina Beltrán <small>(Diseño UI & UX)</small></span></li>\n    <!--<li><span>Juan José Monteleone</span></li>-->\n    <li><span>Germán Villafañe <small>(Implementación)</small></span></li>\n  </ul>\n\n  <p class=\"agradecimientos\">\n    Un Gracias inmenso a  Miguel Verón ,  Leonardo Lambardi,  Adriana Vidal, Verónica Wogeschaffen , Analía González, Patricia Adamini, Eugenia Heredia, Julio Shinca, Fernando M. Waltos, Rosana Froiz, Amadeo Carrizo, Andrés Gomel, Christian Beri, Pedro Luis Peretti, Viviana Verón y Juan José Monteleone , por sus aportes a este proyecto, y muy especialmente a María Elena Patzer por haber soñado y hecho posible el entorno pedagógico PAD, con trabajo, compromiso y calidez.\n  </p>\n\n  <div class=\"aboutus-footer\">\n    <p><small>Producido por la DTE</small></p>\n    <p><small>Dirección General de Cultura y Educación</small></p>\n    <p><small>Provincia de Buenos Aires</small></p>\n  </div>\n</div>\n");
$templateCache.put("app/contacto/contacto.html","<div class=\"container-fluid\">\n    \n  <div class=\"section-header\">\n    <div class=\"row\">\n      <div class=\"col-sm-8 col-sm-offset-2 col-md-8 col-md-offset-2 col-lg-10 col-lg-offset-1\">\n        <h1 data-area=\"{{area}}\">\n          <a title=\"Volver\" href=\"javascript:window.history.back()\" class=\"go-back\"><i class=\"fa fa-chevron-circle-left\"></i></a> Contacto</h1>\n      </div>\n    </div>\n  </div>\n\n  <div class=\"row\" ng-hide=\"axisCollection.length === 0\">\n    <div class=\"col-sm-8 col-sm-offset-2 col-md-8 col-md-offset-2 col-lg-10 col-lg-offset-1\">\n      <address>\n        <p>Por cualquier duda o consulta comunicate con nosotros a: <a href=\"mailto:padbuenosaires@gmail.com\">padbuenosaires@gmail.com</a></p>\n      </address>\n    </div>\n  </div>\n  <div class=\"footer-divider\"></div>\n\n</div>");
...
$templateCache.put("app/main/orientacion.html","<div class=\"container\">\n  \n  <div class=\"row welcome-wrap\">\n    <div class=\"col-sm-11 col-sm-offset-1\">\n\n      <div class=\"row\">\n        \n        <div class=\"aboutus\" ng-show=\"isDesktop\" style=\"margin-top: 50px;\">\n          <h4>Tu carpeta de recursos se encuentra en:</h4>\n          <p>\n          <i class=\"fa fa-folder-open\"></i> {{repository}}\n          </p>\n        </div>\n        <hr style=\"margin-top: 10px; margin-bottom: 10px;\">\n        <div class=\"aboutus\">\n          <h4>Materiales de trabajo para la integración de las TIC en las escuelas primarias.</h4>\n\n          <p>Esta serie de materiales  de trabajo para la integración de las TIC en las escuelas primarias bonaerenses invita a todos los docentes a pensar la alfabetización digital  en el nuevo contexto social que implica nuevos  desafíos y oportunidades para construir  aprendizaje significativo. \n Apuntando a  potenciar las propuestas de enseñanza, enriquecer los estrategias e  intervenciones para favorecer los aprendizajes de todos los alumnos y alumnas de nuestras escuelas.</p>\n\n          <p>\n            Estos se encontrarán en distintos formatos y soportes para ampliar la oferta de accesos que  se integrarán en el escritorio provincial de alfabetización digital, PAD,  en el sitio ABC con opción de una lectura hipertextual entre los distintos materiales con el objeto de que los docentes se los apropien y usen  según sus expectativas y necesidades desde un sentido crítico , reflexivo y creativo.\n          </p>\n            \n          <p>Algunos de los aspectos que proponemos pensar:</p>\n\n          <p>El lugar pedagógico que supone integrar las TIC en las prácticas docentes , superando lo instrumental para la enseñanza de las diferentes áreas curriculares, que  presenta el PAD como  estrategia de enseñanza acorde a estos tiempos  digital en el marco de la política educativa de la Provincia de Buenos Aires.</p>\n\n          <ul>\n            <li>\n              <strong>La gestión  escolar con TIC en las escuelas primarias de la Provincia.</strong>\n              <p>Problematiza el lugar de las TIC en la gestión de las escuelas, tanto en lo administrativo como en lo pedagógico,  y sus potencialidades  como herramientas para la conducción y la organización institucional.</p>\n            </li>\n            <li>\n              <strong>La gestión del aula con TIC.</strong>\n              <p>El lugar de la planificación y las intervenciones del docente en la reconfiguración del tiempo y el espacio aúlico; la posibilidad de diversificar los contenidos y los niveles de aproximación al conocimiento habilita la inclusión transversal que se pueden propiciar a partir de las TIC en todas las áreas de conocimiento , alternativa que genera la incorporación de los nuevos dispositivos tecnológicos en el aula.</p>\n            </li>\n            <li>\n              <strong>La reconfiguración de la enseñanza en diálogo con los procesos de lectura y escritura propiciadas por la TIC.</strong>\n              <p>La posibilidad de propiciar otros diálogos, otros modos de construir los textos, los sentidos y la dimensión comunicacional del aula.</p>\n            </li>\n            <li>\n              <strong> El PAD como espacio  provincial de recursos para favorecer y enriquecer  la enseñanza con TIC.</strong>\n              <p>Fundamentación, objetivos y desarrollo del PAD ofrecidos por  Tecnología Educativa   dependiente de  la Dirección Provincial de Tecnología Educativa de la D.G.C y  E en  el marco del Diseño Curricular provincial  para la construcción de los recursos .</p>\n            </li>\n            <li>\n              <strong>El PAD llega a las escuelas y al aula.</strong>\n              <p>El lugar de los asistentes digitales para la enseñanza de las áreas curriculares:   criterios para su selección e incorporación en propuestas de enseñanza enmarcadas en el Diseño Curricular del Nivel. “Lo común” y “lo diferente”: los aspectos comunes y generales a la hora de diseñar situaciones de enseñanza con recursos digitales, y las especificidades de las áreas curriculares en dicho proceso.</p>\n            </li>\n            \n          </ul>\n          \n          <!--<p class=\"importante\">\n            <strong>IMPORTANTE:</strong> <i>Esta descripción engloba al primer alcance de una serie de documentos que se incluirán en esta sección. Hoy acercamos el primero de esta serie. En una segunda etapa, se ofrecerán desarrollos vinculados a las áreas curriculares y a la gestión institucional.</i>\n          </p>-->\n\n        </div>\n\n      </div>\n    </div>\n  </div>\n</div>");
